...
export const ScrollLink: FC<TScrollLinkProps> = ({ to, offset = -100, children, active, isButton }) => {
  ...
  return (
    <Styled.CustomLink href={to} onClick={handleClick} $active={active} $isButton={isButton}>
      {children}
    </Styled.CustomLink>
  )
}
