...
export const homePageMock: THomePage = {
  ...
  k8sToday: {
    ...
    description: `Разные интерфейсы и инструменты, раздробленные процессы, рост расходов и сложность масштабирования. Сотни кластеров, десятки команд - и ни одной общей точки зрения.`,
    cards: [
      {
